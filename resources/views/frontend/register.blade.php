...
<body class="bg-gradient-primary">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-md-5">
          	<img src="frontend/images/1.jpg" class="img-fluid w-100 h-100 d-block mx-auto">
          </div>
          <div class="col-md-7">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="backend/signup.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="password" class="form-control form-control-user" placeholder="User Password" name="user_password" value="">
